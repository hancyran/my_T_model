...
from src.module.core import LocalActivationUnit
from src.module.normalization import LayerNormalization
from src.module.rnn import dynamic_rnn
from src.utils.contrib_utils import QAAttGRUCell, VecAttGRUCell
...
class Transformer(Layer):
    ...
    def build(self, input_shape):
        ...
        # if self.use_res: self.W_Res = self.add_weight(name='res', shape=[embedding_size, self.att_embedding_size *
        # self.head_num], dtype=tf.float32, initializer=tf.keras.initializers.TruncatedNormal(seed=self.seed))
