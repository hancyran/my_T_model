...
from src.module.core import DNN, PredictionLayer
from src.module.input_embedding import preprocess_input_embedding, get_linear_logit
from src.module.interaction import FM
from src.utils.utils import check_feature_config_dict, concat_fun
...
def DeepFM(feature_dim_dict, embedding_size=8,
           ...
           init_std=0.0001, seed=2019, dnn_dropout=0, dnn_activation='relu', dnn_use_bn=False, task='regression'):
